...
public class ExternalManagement implements Phase{
	DeliveryEngineApp commandCenter = new DeliveryEngineApp();
	private AddPhasesBean fBean;
	public ExternalManagement(AddPhasesBean firstCompositionBean){
	...
	public void execute() {
		...
		DeliveryEngineApp.driver.findElement(By.id(DeliveryEngineUI_ID.EXTERNALPROGRAM_ADDOPERATION)).click();
		DeliveryEngineApp.driver.findElement(By.id(DeliveryEngineUI_ID.EXTERNALPROGRAM_COMMANDEXP)).sendKeys("mkdir");
		DeliveryEngineApp.driver.findElement(By.id(DeliveryEngineUI_ID.EXTERNALPROGRAM_ARGUMENTS)).sendKeys("{cc_root}");
		DeliveryEngineApp.driver.findElement(By.id(DeliveryEngineUI_ID.EXTERNALPROGRAM_FILED)).sendKeys("ls");
